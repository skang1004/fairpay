            ...
            react_1.default.createElement("div", { className: "data_display_div" },
                react_1.default.createElement(core_1.TableContainer, { component: core_1.Paper },
                    react_1.default.createElement(core_1.Table, { className: "table_displays" },
                        ...
                        react_1.default.createElement(core_1.TableBody, null, props.aggregateList.map(function (row) { return (react_1.default.createElement(core_1.TableRow, { key: row },
                            ...
                            react_1.default.createElement(core_1.TableCell, { align: "right" },
                                "$",
                                row.avg_stock))); }))))),
            react_1.default.createElement(CompanyChart_js_1.default, { aggregateList: props.aggregateList, userSalary: props.userSalary, userAnnualBonus: props.userAnnualBonus, userStockOptions: props.userStockOptions }))));
}
exports.default = TotalCity;
//# sourceMappingURL=Total_City.js.map